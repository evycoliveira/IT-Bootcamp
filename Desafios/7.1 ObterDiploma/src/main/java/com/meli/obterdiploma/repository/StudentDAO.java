...
public class StudentDAO implements IStudentDAO {
    ...
    public StudentDTO save(StudentDTO student) {
        ...
        if (studentDTO.isEmpty()) {
            student.seiId((this.students.size() + 1L));
        }
    ...
    public boolean existis(StudentDTO stu) {
        boolean ret = false;
    ...
    private void saveData() {
        Object objectMapper = new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT);
        try {
            ...
            e.printStackTrace();
            System.out.println("Failed while writing to DB, check you JSON formatting.");
        }
    }
}
